                        ...
                        <>
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-2 h-12 rounded-lg border border-zinc-800 text-white font-medium hover:bg-zinc-900 transition-colors cursor-pointer"
                                >
                                ...
                                <button className="flex items-center justify-center gap-2 h-12 rounded-lg border border-zinc-800 text-white font-medium hover:bg-zinc-900 transition-colors cursor-pointer">
